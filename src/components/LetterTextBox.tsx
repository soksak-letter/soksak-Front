const LetterTextBox = () => {
  return (
    <div className='relative flex flex-col w-full max-w-xl mx-auto'>
      <div className='rounded-t-md bg-[#EFEFEF] px-4 py-3 text-xl font-medium text-[#8C8C8C] shadow-sm'>
        제목
      </div>

      <textarea
        className='min-h-[350px] resize-none rounded-b-md border border-none
