    ...
    <ModalFrame>
      ...
      >
        ...
        <div className='px-6 py-6 pt-8 text-center flex flex-col items-center justify-center gap-3'>
          <p className='ty-body2 text-[var(--color-text-strong)] leading-[28.8px]'>
        ...
        <div className='grid grid-cols-2'>
          <button
            ...
            className='h-14 bg-[var(--color-grey-300)] text-white ty-body3'
          >
            계속 선택하기
          </button>
          ...
          <button
            type='button'
            onClick={handleSkip}
            className='h-14 bg-[var(--color-primary-500)] text-white ty-body3'
          >
            건너뛰기
          </button>
        </div>
