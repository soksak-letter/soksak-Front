      ...
      <main className='mx-auto w-full max-w-[375px] pb-8'>
        <div style={{ marginTop: '8px' }} className='px-9'>
          ...
          <Section>
            ...
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            <SectionTitle>제7조(회원가입에 대한 승낙과 제한)</SectionTitle>
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            <SectionTitle>제10조(개발자 팀의 의무)</SectionTitle>
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            ...
            <SectionText>8. 기타 관계 법령 또는 공서양속에 반하는 행위</SectionText>
          </Section>

          <Section>
            <SectionTitle>제13조(서비스의 제공 내용)</SectionTitle>
            <SectionText style={{ marginBottom: '4px' }}>
              1. 개발자 팀이 제공하는 서비스는 다음과 같습니다.
            </SectionText>
            <SectionText style={{ marginBottom: '4px' }}>2. 익명 편지 송수신 서비스</SectionText>
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            <SectionTitle>제15조(이용계약의 해지 및 탈퇴)</SectionTitle>
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            <SectionTitle>제16조(손해배상 및 면책)</SectionTitle>
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            <SectionTitle>제17조(권리의 귀속)</SectionTitle>
            <SectionText style={{ marginBottom: '4px' }}>
          ...
          <Section>
            <SectionText style={{ fontWeight: 700, marginBottom: '8px' }}>부칙</SectionText>
            <SectionTitle>제1조(시행일)</SectionTitle>
            <SectionText>본 약관은 2026.2.1부터 시행합니다.</SectionText>
          </Section>
        </div>
      </main>
    </div>
